...
<header class="flex items-center justify-between" style="background-color: #808080;">
        ...
        <div class="text-white text-lg font-medium">Josue Andre Solano Vidurrizaga</div>
    </header>
    </header>
    ...
    <div class="py-8 text-center">
            ...
            <li>
                <h1 class="text-[#9c9fa1] w-[100%] flex justify-center font-semibold mb-4">MENU ALUMNO</h1>
            </li>
            ...
            <li>
                <span class="material-symbols-outlined">ambient_screen</span>
                <a href="./cursos.php">Administra tus clases</a>
            </li>
